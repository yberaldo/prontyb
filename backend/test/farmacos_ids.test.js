...
test('buscarPorId rejeita id "1abc" com 400', async () => {
  const controllerPath = path.resolve(__dirname, '..', 'src', 'controladores', 'farmacos.controlador.js');
...
test('buscarPorId com id "1" chama servico e retorna sucesso', async () => {
  const servicePath = path.resolve(__dirname, '..', 'src', 'servicos', 'farmacos.servico.js');
  const controllerPath = path.resolve(__dirname, '..', 'src', 'controladores', 'farmacos.controlador.js');
